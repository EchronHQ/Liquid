    ...
    public function __construct(SqlRemoteService $remoteService, private readonly TemplateHelper $templateHelper, LocaleHelper $localeHelper)
    {
        ...
        $this->posts = [
            ...
            PostDefinition::generate('how-digitization-can-help-your-business', [
                ...
                'intro' => "In today's world, data is the crux of major business decisions used by " . $localeHelper->translate('organizations') . " all over the world. As such, it is imperative that the " . $localeHelper->translate('organizations') . " have access to the right data and be able to " . $localeHelper->translate('analyse') . " and make business decisions proactively.",
                'seo_keywords' => '',
